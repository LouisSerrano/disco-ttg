...
from src.disco_ablations import DiscoAblations
...
def get_run_name(cfg: DictConfig) -> str:
    ...
    # Combine all parts
    return f"Ablations_DISCO_{dataset_name}_{'_'.join(model_params)}_{'_'.join(train_params)}_{'_'.join(data_params)}"

@hydra.main(config_path="../configs", config_name="ablations")
