...
class DISCOLitModule(L.LightningModule):
    def __init__(self, model_cfg, training_cfg):
        ...
        self.num_environments = 40  # Number of training environments (adjust based on your dataset)
    ...
    def training_step(self, batch, batch_idx):
        ...
        # Randomly decide whether to use codebook for each sample (75% probability)
