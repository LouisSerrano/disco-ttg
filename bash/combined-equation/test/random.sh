...
python test_time_compute/test_combined_equation.py --model_path  /mnt/home/lserrano/disco-ball/outputs/$ckpt_path/last.ckpt --methods random --experiment E_EULER_OOD

python test_time_compute/test_combined_equation.py --model_path  /mnt/home/lserrano/disco-ball/outputs/$ckpt_path/last.ckpt --methods random --experiment E_DISP_OOD
