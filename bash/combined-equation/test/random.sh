...
python test_time_compute/equations/test_combined_equation.py --model_path  ${DISCO_OUTPUTS:-./outputs}/$ckpt_path/last.ckpt --methods random --experiment E_EULER_OOD

python test_time_compute/equations/test_combined_equation.py --model_path  ${DISCO_OUTPUTS:-./outputs}/$ckpt_path/last.ckpt --methods random --experiment E_DISP_OOD
