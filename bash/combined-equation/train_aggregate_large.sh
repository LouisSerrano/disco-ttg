...
python3 train/train_combined_aggregate.py \
    model.max_steps=1 \
    ...
    data.sub_t=1 \
    data.train_hdf5_files=["${DISCO_DATA:-./datasets}/combined_equation/E_EULER_train_envsize128.h5","${DISCO_DATA:-./datasets}/combined_equation/E_HEAT_train_envsize128.h5","${DISCO_DATA:-./datasets}/combined_equation/E_DISP_train_envsize128.h5"] \
