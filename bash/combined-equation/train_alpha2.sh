...
python3 train/train_combined.py \
    ...
    data.sub_t=1 \
    data.train_hdf5_files=["${DISCO_MPP_DATA:-./datasets/mp-neural}/OP_Euler_train_alpha2.0_beta0.0_gamma0.0_1024.h5"] \
    data.val_hdf5_files=["${DISCO_MPP_DATA:-./datasets/mp-neural}/OP_Euler_valid_alpha2.0_beta0.0_gamma0.0.h5"] \
    data.test_hdf5_files=["${DISCO_MPP_DATA:-./datasets/mp-neural}/OP_Euler_test_alpha2.0_beta0.0_gamma0.0.h5"]
