...
python3 test-time-compute/eval_perturbation.py \
    ...
    --data_dir ./test-time-compute/results/perturbation_data \
    --output_dir ./test-time-compute/results/rebuttal/perturbation_eval/eps_0.05 \
