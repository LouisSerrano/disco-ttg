...
#MODEL_CHECKPOINT="DISCO_advection-diffusion_adjFalse_h128_t2_steps10_bs64_lr0.0005_ctxTrue_inframes16_outframes2_T10" 
#MODEL_CHECKPOINT="DISCO_advection-diffusion_adjTrue_h128_t2_steps10_bs64_lr0.0005_ctxTrue_inframes16_outframes2_T10"
...
MODEL_CHECKPOINT="DISCO_advection-diffusion_solverrk4_adjFalse_h128_t2_steps1_bs64_lr0.0002_ctxTrue_inframes16_outframes2_T10"
...
python3 tests/test_operator_composition.py hydra.run.dir=. test.run_name=$MODEL_CHECKPOINT test.ckpt_path=outputs/$MODEL_CHECKPOINT/best-checkpoint-v1.ckpt
