...
# Model checkpoint to use (without context)
MODEL_CHECKPOINT="DISCO_advection-diffusion_adjFalse_h128_t2_steps1_bs64_lr0.0005_ctxFalse_inframes16_outframes2_T10.0"
